...
static void GetWeightedVarianceMatrix(CEquiEnergyModel &model, int stage, const std::vector<CSampleIDWeight> &); 
static bool ReadScaleFromFile(const string &file_name, double &c); 
static bool WriteScaleToFile(const string &file_name, double c); 
static bool FileExist(const string &file_name); 
static double ScaleFit(double*, double*, const int, CEquiEnergyModel &model, int stage, int nNode, int nInitial);
static vector<int> StriationDistribution(const vector<CSampleIDWeight> &samples, const CEquiEnergyModel &model, int stage); 
...
static void GetWeightedVarianceMatrix(CEquiEnergyModel &model, int stage, const std::vector<CSampleIDWeight> &samples)
{
...
static double ScaleFit(double *sPackage, double *rPackage, const int N_MESSAGE, CEquiEnergyModel &model, int stage, int nNode, int nInitial)
{
